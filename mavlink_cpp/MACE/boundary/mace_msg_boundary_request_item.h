...
#define MACE_MSG_ID_BOUNDARY_REQUEST_ITEM_CRC 205
#define MACE_MSG_ID_134_CRC 205
...
#define MACE_MESSAGE_INFO_BOUNDARY_REQUEST_ITEM { \
    ...
    {  { "seq", NULL, MACE_TYPE_UINT16_T, 0, 0, offsetof(mace_boundary_request_item_t, seq) }, \
         { "boundary_system", NULL, MACE_TYPE_UINT8_T, 0, 2, offsetof(mace_boundary_request_item_t, boundary_system) }, \
         { "boundary_creator", NULL, MACE_TYPE_UINT8_T, 0, 3, offsetof(mace_boundary_request_item_t, boundary_creator) }, \
         { "boundary_type", NULL, MACE_TYPE_UINT8_T, 0, 4, offsetof(mace_boundary_request_item_t, boundary_type) }, \
         } \
}
#else
#define MACE_MESSAGE_INFO_BOUNDARY_REQUEST_ITEM { \
...
static inline uint16_t mace_msg_boundary_request_item_pack(uint8_t system_id, uint8_t component_id, mace_message_t* msg,
                               uint8_t boundary_system, uint8_t boundary_creator, uint8_t boundary_type, uint16_t seq)
{
...
{
    return mace_msg_boundary_request_item_pack(system_id, component_id, msg, boundary_request_item->boundary_system, boundary_request_item->boundary_creator, boundary_request_item->boundary_type, boundary_request_item->seq);
}
...
{
    return mace_msg_boundary_request_item_pack_chan(system_id, component_id, chan, msg, boundary_request_item->boundary_system, boundary_request_item->boundary_creator, boundary_request_item->boundary_type, boundary_request_item->seq);
}
...
static inline void mace_msg_boundary_request_item_send(mace_channel_t chan, uint8_t boundary_system, uint8_t boundary_creator, uint8_t boundary_type, uint16_t seq)
{
#if MACE_NEED_BYTE_SWAP || !MACE_ALIGNED_FIELDS
    char buf[MACE_MSG_ID_BOUNDARY_REQUEST_ITEM_LEN];
    _mace_put_uint16_t(buf, 0, seq);
...
{
#if MACE_NEED_BYTE_SWAP || !MACE_ALIGNED_FIELDS
    mace_msg_boundary_request_item_send(chan, boundary_request_item->boundary_system, boundary_request_item->boundary_creator, boundary_request_item->boundary_type, boundary_request_item->seq);
#else
 ...
 */
static inline void mace_msg_boundary_request_item_send_buf(mace_message_t *msgbuf, mace_channel_t chan,  uint8_t boundary_system, uint8_t boundary_creator, uint8_t boundary_type, uint16_t seq)
{
#if MACE_NEED_BYTE_SWAP || !MACE_ALIGNED_FIELDS
...
/**
 * @brief Get field boundary_system from boundary_request_item message
 *
 * @return System ID
 */
static inline uint8_t mace_msg_boundary_request_item_get_boundary_system(const mace_message_t* msg)
{
    return _MACE_RETURN_uint8_t(msg,  2);
}

/**
 * @brief Get field boundary_creator from boundary_request_item message
 *
 * @return Creator ID
 */
static inline uint8_t mace_msg_boundary_request_item_get_boundary_creator(const mace_message_t* msg)
{
    return _MACE_RETURN_uint8_t(msg,  3);
}

/**
 * @brief Get field boundary_type from boundary_request_item message
 *
 * @return Boundary type, see BOUNDARY_TYPE
 */
static inline uint8_t mace_msg_boundary_request_item_get_boundary_type(const mace_message_t* msg)
{
...
static inline void mace_msg_boundary_request_item_decode(const mace_message_t* msg, mace_boundary_request_item_t* boundary_request_item)
{
    ...
    boundary_request_item->boundary_system = mace_msg_boundary_request_item_get_boundary_system(msg);
    boundary_request_item->boundary_creator = mace_msg_boundary_request_item_get_boundary_creator(msg);
    boundary_request_item->boundary_type = mace_msg_boundary_request_item_get_boundary_type(msg);
#else
