...
TEST(boundary, BOUNDARY_COUNT)
{
    ...
    packet_in.boundary_system = 139;
    packet_in.boundary_creator = 206;
    packet_in.boundary_type = 17;
...
TEST(boundary, BOUNDARY_ITEM)
{
    ...
    packet_in.boundary_system = 175;
    packet_in.boundary_creator = 242;
    packet_in.boundary_type = 53;
    packet_in.seq = 17859;
    packet_in.frame = 120;
    packet_in.x = 17.0;
    packet_in.y = 45.0;
