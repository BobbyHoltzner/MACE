...
static void mace_test_new_boundary_object(uint8_t system_id, uint8_t component_id, mace_message_t *last_msg)
{
    ...
    mace_msg_new_boundary_object_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mace_msg_new_boundary_object_pack(system_id, component_id, &msg , packet1.boundary_system , packet1.boundary_creator , packet1.boundary_type );
    mace_msg_new_boundary_object_decode(&msg, &packet2);
        MACE_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mace_msg_new_boundary_object_pack_chan(system_id, component_id, MACE_COMM_0, &msg , packet1.boundary_system , packet1.boundary_creator , packet1.boundary_type );
    mace_msg_new_boundary_object_decode(&msg, &packet2);
        MACE_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mace_msg_new_boundary_object_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mace_msg_new_boundary_object_send(MACE_COMM_1 , packet1.boundary_system , packet1.boundary_creator , packet1.boundary_type );
    mace_msg_new_boundary_object_decode(last_msg, &packet2);
        MACE_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mace_test_boundary_request_list(uint8_t system_id, uint8_t component_id, mace_message_t *last_msg)
{
    ...
    mace_msg_boundary_request_list_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mace_msg_boundary_request_list_pack(system_id, component_id, &msg , packet1.boundary_system , packet1.boundary_creator , packet1.boundary_type );
    mace_msg_boundary_request_list_decode(&msg, &packet2);
        MACE_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mace_msg_boundary_request_list_pack_chan(system_id, component_id, MACE_COMM_0, &msg , packet1.boundary_system , packet1.boundary_creator , packet1.boundary_type );
    mace_msg_boundary_request_list_decode(&msg, &packet2);
        MACE_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mace_msg_boundary_request_list_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mace_msg_boundary_request_list_send(MACE_COMM_1 , packet1.boundary_system , packet1.boundary_creator , packet1.boundary_type );
    mace_msg_boundary_request_list_decode(last_msg, &packet2);
        MACE_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mace_test_boundary_count(uint8_t system_id, uint8_t component_id, mace_message_t *last_msg)
{
    ...
    mace_msg_boundary_count_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mace_msg_boundary_count_pack(system_id, component_id, &msg , packet1.boundary_system , packet1.boundary_creator , packet1.boundary_type , packet1.count );
    mace_msg_boundary_count_decode(&msg, &packet2);
        MACE_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mace_msg_boundary_count_pack_chan(system_id, component_id, MACE_COMM_0, &msg , packet1.boundary_system , packet1.boundary_creator , packet1.boundary_type , packet1.count );
    mace_msg_boundary_count_decode(&msg, &packet2);
        MACE_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mace_msg_boundary_count_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mace_msg_boundary_count_send(MACE_COMM_1 , packet1.boundary_system , packet1.boundary_creator , packet1.boundary_type , packet1.count );
    mace_msg_boundary_count_decode(last_msg, &packet2);
        MACE_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mace_test_boundary_request_item(uint8_t system_id, uint8_t component_id, mace_message_t *last_msg)
{
    ...
    mace_msg_boundary_request_item_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mace_msg_boundary_request_item_pack(system_id, component_id, &msg , packet1.boundary_system , packet1.boundary_creator , packet1.boundary_type , packet1.seq );
    mace_msg_boundary_request_item_decode(&msg, &packet2);
        MACE_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mace_msg_boundary_request_item_pack_chan(system_id, component_id, MACE_COMM_0, &msg , packet1.boundary_system , packet1.boundary_creator , packet1.boundary_type , packet1.seq );
    mace_msg_boundary_request_item_decode(&msg, &packet2);
        MACE_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mace_msg_boundary_request_item_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mace_msg_boundary_request_item_send(MACE_COMM_1 , packet1.boundary_system , packet1.boundary_creator , packet1.boundary_type , packet1.seq );
    mace_msg_boundary_request_item_decode(last_msg, &packet2);
        MACE_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mace_test_boundary_item(uint8_t system_id, uint8_t component_id, mace_message_t *last_msg)
{
    ...
    mace_msg_boundary_item_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mace_msg_boundary_item_pack(system_id, component_id, &msg , packet1.boundary_system , packet1.boundary_creator , packet1.boundary_type , packet1.seq , packet1.frame , packet1.x , packet1.y , packet1.z );
    mace_msg_boundary_item_decode(&msg, &packet2);
        MACE_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mace_msg_boundary_item_pack_chan(system_id, component_id, MACE_COMM_0, &msg , packet1.boundary_system , packet1.boundary_creator , packet1.boundary_type , packet1.seq , packet1.frame , packet1.x , packet1.y , packet1.z );
    mace_msg_boundary_item_decode(&msg, &packet2);
        MACE_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mace_msg_boundary_item_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mace_msg_boundary_item_send(MACE_COMM_1 , packet1.boundary_system , packet1.boundary_creator , packet1.boundary_type , packet1.seq , packet1.frame , packet1.x , packet1.y , packet1.z );
    mace_msg_boundary_item_decode(last_msg, &packet2);
        MACE_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
