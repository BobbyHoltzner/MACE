...
#define MACE_MSG_ID_MISSION_ACK_CRC 169
#define MACE_MSG_ID_102_CRC 169
...
#define MACE_MESSAGE_INFO_MISSION_ACK { \
    ...
    "MISSION_ACK", \
    7, \
    {  { "target_system", NULL, MACE_TYPE_UINT8_T, 0, 0, offsetof(mace_mission_ack_t, target_system) }, \
         { "mission_system", NULL, MACE_TYPE_UINT8_T, 0, 1, offsetof(mace_mission_ack_t, mission_system) }, \
         { "mission_creator", NULL, MACE_TYPE_UINT8_T, 0, 2, offsetof(mace_mission_ack_t, mission_creator) }, \
         { "mission_id", NULL, MACE_TYPE_UINT8_T, 0, 3, offsetof(mace_mission_ack_t, mission_id) }, \
         { "mission_type", NULL, MACE_TYPE_UINT8_T, 0, 4, offsetof(mace_mission_ack_t, mission_type) }, \
         { "mission_state", NULL, MACE_TYPE_UINT8_T, 0, 5, offsetof(mace_mission_ack_t, mission_state) }, \
         { "mission_result", NULL, MACE_TYPE_UINT8_T, 0, 6, offsetof(mace_mission_ack_t, mission_result) }, \
         } \
}
#else
#define MACE_MESSAGE_INFO_MISSION_ACK { \
...
static inline uint16_t mace_msg_mission_ack_pack(uint8_t system_id, uint8_t component_id, mace_message_t* msg,
                               uint8_t target_system, uint8_t mission_system, uint8_t mission_creator, uint8_t mission_id, uint8_t mission_type, uint8_t mission_state, uint8_t mission_result)
{
    ...
    _mace_put_uint8_t(buf, 6, mission_result);
...
{
    return mace_msg_mission_ack_pack(system_id, component_id, msg, mission_ack->target_system, mission_ack->mission_system, mission_ack->mission_creator, mission_ack->mission_id, mission_ack->mission_type, mission_ack->mission_state, mission_ack->mission_result);
}
...
{
    return mace_msg_mission_ack_pack_chan(system_id, component_id, chan, msg, mission_ack->target_system, mission_ack->mission_system, mission_ack->mission_creator, mission_ack->mission_id, mission_ack->mission_type, mission_ack->mission_state, mission_ack->mission_result);
}
...
static inline void mace_msg_mission_ack_send(mace_channel_t chan, uint8_t target_system, uint8_t mission_system, uint8_t mission_creator, uint8_t mission_id, uint8_t mission_type, uint8_t mission_state, uint8_t mission_result)
{
#if MACE_NEED_BYTE_SWAP || !MACE_ALIGNED_FIELDS
    char buf[MACE_MSG_ID_MISSION_ACK_LEN];
    _mace_put_uint8_t(buf, 0, target_system);
...
{
#if MACE_NEED_BYTE_SWAP || !MACE_ALIGNED_FIELDS
    mace_msg_mission_ack_send(chan, mission_ack->target_system, mission_ack->mission_system, mission_ack->mission_creator, mission_ack->mission_id, mission_ack->mission_type, mission_ack->mission_state, mission_ack->mission_result);
#else
 ...
 */
static inline void mace_msg_mission_ack_send_buf(mace_message_t *msgbuf, mace_channel_t chan,  uint8_t target_system, uint8_t mission_system, uint8_t mission_creator, uint8_t mission_id, uint8_t mission_type, uint8_t mission_state, uint8_t mission_result)
{
#if MACE_NEED_BYTE_SWAP || !MACE_ALIGNED_FIELDS
 ...
 * @return System ID
 */
static inline uint8_t mace_msg_mission_ack_get_target_system(const mace_message_t* msg)
{
...
/**
 * @brief Get field mission_state from mission_ack message
 *
 * @return The potential new mission state, see MISSION_STATE
 */
static inline uint8_t mace_msg_mission_ack_get_mission_state(const mace_message_t* msg)
{
...
{
#if MACE_NEED_BYTE_SWAP || !MACE_ALIGNED_FIELDS
    mission_ack->target_system = mace_msg_mission_ack_get_target_system(msg);
    ...
    mission_ack->mission_state = mace_msg_mission_ack_get_mission_state(msg);
