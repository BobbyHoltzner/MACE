...
#define MACE_MSG_ID_MISSION_ACK_LEN 6
#define MACE_MSG_ID_MISSION_ACK_MIN_LEN 6
#define MACE_MSG_ID_102_LEN 6
#define MACE_MSG_ID_102_MIN_LEN 6

#define MACE_MSG_ID_MISSION_ACK_CRC 110
#define MACE_MSG_ID_102_CRC 110
...
{
    return mace_msg_mission_ack_pack(system_id, component_id, msg, mission_ack->target_system, mission_ack->mission_system, mission_ack->mission_creator, mission_ack->mission_id, mission_ack->mission_type, mission_ack->mission_state);
}
...
{
    return mace_msg_mission_ack_pack_chan(system_id, component_id, chan, msg, mission_ack->target_system, mission_ack->mission_system, mission_ack->mission_creator, mission_ack->mission_id, mission_ack->mission_type, mission_ack->mission_state);
}
...
static inline void mace_msg_mission_ack_send(mace_channel_t chan, uint8_t target_system, uint8_t mission_system, uint8_t mission_creator, uint8_t mission_id, uint8_t mission_type, uint8_t mission_state)
{
#if MACE_NEED_BYTE_SWAP || !MACE_ALIGNED_FIELDS
    char buf[MACE_MSG_ID_MISSION_ACK_LEN];
    _mace_put_uint8_t(buf, 0, target_system);
...
{
#if MACE_NEED_BYTE_SWAP || !MACE_ALIGNED_FIELDS
    mace_msg_mission_ack_send(chan, mission_ack->target_system, mission_ack->mission_system, mission_ack->mission_creator, mission_ack->mission_id, mission_ack->mission_type, mission_ack->mission_state);
#else
 ...
 */
static inline void mace_msg_mission_ack_send_buf(mace_message_t *msgbuf, mace_channel_t chan,  uint8_t target_system, uint8_t mission_system, uint8_t mission_creator, uint8_t mission_id, uint8_t mission_type, uint8_t mission_state)
{
#if MACE_NEED_BYTE_SWAP || !MACE_ALIGNED_FIELDS
