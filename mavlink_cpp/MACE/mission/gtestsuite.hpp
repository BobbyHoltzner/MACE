...
TEST(mission, MISSION_CURRENT)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::mission::msg::MISSION_CURRENT packet_in{};
    packet_in.mission_system = 139;
    packet_in.mission_creator = 206;
    packet_in.mission_id = 17;
    packet_in.mission_type = 84;
    ...
    mavlink::mission::msg::MISSION_CURRENT packet1{};
    mavlink::mission::msg::MISSION_CURRENT packet2{};
...
#ifdef TEST_INTEROP
TEST(mission_interop, MISSION_CURRENT)
{
    mavlink_message_t msg;
