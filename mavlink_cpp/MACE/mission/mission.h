...
#define MACE_MESSAGE_CRCS {{100, 132, 5, 0, 0, 0}, {101, 18, 7, 1, 2, 0}, {102, 169, 7, 1, 0, 0}, {103, 135, 3, 0, 0, 0}, {104, 84, 5, 0, 0, 0}, {105, 165, 8, 1, 2, 0}, {106, 3, 8, 1, 2, 0}, {107, 111, 40, 1, 32, 0}, {108, 4, 7, 3, 4, 5}, {109, 168, 7, 3, 4, 5}, {110, 224, 4, 0, 0, 0}, {111, 156, 5, 0, 0, 0}, {112, 233, 6, 0, 0, 0}, {113, 103, 6, 0, 0, 0}, {114, 34, 4, 1, 0, 0}, {115, 55, 5, 0, 0, 0}, {116, 36, 1, 1, 0, 0}, {117, 104, 52, 0, 0, 0}, {118, 85, 53, 1, 52, 0}, {119, 109, 17, 0, 0, 0}}
#endif
...
typedef enum MAV_MISSION_STATE
{
   ...
   MAV_MISSION_TRANSMITTED=3, /* Items have been distributed and received by the appropriate MACE instance connected to the associated aircraft module. | */
   MAV_MISSION_STATE_ENUM_END=4, /*  | */
} MAV_MISSION_STATE;
#endif
...
#include "./mace_msg_mission_current.h"
