...
#define MACE_MESSAGE_INFO_HOME_POSITION { \
    ...
    {  { "latitude", NULL, MACE_TYPE_INT32_T, 0, 0, offsetof(mace_home_position_t, latitude) }, \
         ...
         { "x", NULL, MACE_TYPE_FLOAT, 0, 12, offsetof(mace_home_position_t, x) }, \
         { "y", NULL, MACE_TYPE_FLOAT, 0, 16, offsetof(mace_home_position_t, y) }, \
         { "z", NULL, MACE_TYPE_FLOAT, 0, 20, offsetof(mace_home_position_t, z) }, \
         { "q", NULL, MACE_TYPE_FLOAT, 4, 24, offsetof(mace_home_position_t, q) }, \
                               ...
                               int32_t latitude, int32_t longitude, int32_t altitude, float x, float y, float z, const float *q, float approach_x, float approach_y, float approach_z)
{
    ...
    msg->msgid = MACE_MSG_ID_HOME_POSITION;
    return mace_finalize_message(msg, system_id, component_id, MACE_MSG_ID_HOME_POSITION_MIN_LEN, MACE_MSG_ID_HOME_POSITION_LEN, MACE_MSG_ID_HOME_POSITION_CRC);
}
                                   ...
                                   int32_t latitude,int32_t longitude,int32_t altitude,float x,float y,float z,const float *q,float approach_x,float approach_y,float approach_z)
{
    ...
    msg->msgid = MACE_MSG_ID_HOME_POSITION;
    return mace_finalize_message_chan(msg, system_id, component_id, chan, MACE_MSG_ID_HOME_POSITION_MIN_LEN, MACE_MSG_ID_HOME_POSITION_LEN, MACE_MSG_ID_HOME_POSITION_CRC);
}
...
#if MACE_MSG_ID_HOME_POSITION_LEN <= MACE_MAX_PAYLOAD_LEN
/*
...
static inline void mace_msg_home_position_send_buf(mace_message_t *msgbuf, mace_channel_t chan,  int32_t latitude, int32_t longitude, int32_t altitude, float x, float y, float z, const float *q, float approach_x, float approach_y, float approach_z)
{
    ...
    _mace_finalize_message_chan_send(chan, MACE_MSG_ID_HOME_POSITION, buf, MACE_MSG_ID_HOME_POSITION_MIN_LEN, MACE_MSG_ID_HOME_POSITION_LEN, MACE_MSG_ID_HOME_POSITION_CRC);
#else
    mace_home_position_t *packet = (mace_home_position_t *)msgbuf;
    packet->latitude = latitude;
    packet->longitude = longitude;
    packet->altitude = altitude;
    packet->x = x;
 ...
 */
static inline int32_t mace_msg_home_position_get_latitude(const mace_message_t* msg)
{
 ...
 */
static inline int32_t mace_msg_home_position_get_longitude(const mace_message_t* msg)
{
 ...
 */
static inline int32_t mace_msg_home_position_get_altitude(const mace_message_t* msg)
{
 ...
 */
static inline float mace_msg_home_position_get_x(const mace_message_t* msg)
{
 ...
 */
static inline float mace_msg_home_position_get_y(const mace_message_t* msg)
{
 ...
 */
static inline float mace_msg_home_position_get_z(const mace_message_t* msg)
{
 ...
 */
static inline uint16_t mace_msg_home_position_get_q(const mace_message_t* msg, float *q)
{
 ...
 */
static inline float mace_msg_home_position_get_approach_x(const mace_message_t* msg)
{
 ...
 */
static inline float mace_msg_home_position_get_approach_y(const mace_message_t* msg)
{
 ...
 */
static inline float mace_msg_home_position_get_approach_z(const mace_message_t* msg)
{
 ...
 */
static inline void mace_msg_home_position_decode(const mace_message_t* msg, mace_home_position_t* home_position)
{
#if MACE_NEED_BYTE_SWAP || !MACE_ALIGNED_FIELDS
    home_position->latitude = mace_msg_home_position_get_latitude(msg);
    home_position->longitude = mace_msg_home_position_get_longitude(msg);
    home_position->altitude = mace_msg_home_position_get_altitude(msg);
    home_position->x = mace_msg_home_position_get_x(msg);
    home_position->y = mace_msg_home_position_get_y(msg);
    home_position->z = mace_msg_home_position_get_z(msg);
    mace_msg_home_position_get_q(msg, home_position->q);
    ...
    memcpy(home_position, _MACE_PAYLOAD(msg), len);
#endif
}
