...
#define MACE_MSG_ID_COMMAND_SHORT_LEN 6
#define MACE_MSG_ID_COMMAND_SHORT_MIN_LEN 6
#define MACE_MSG_ID_31_LEN 6
#define MACE_MSG_ID_31_MIN_LEN 6

#define MACE_MSG_ID_COMMAND_SHORT_CRC 226
#define MACE_MSG_ID_31_CRC 226
...
#define MACE_MESSAGE_INFO_COMMAND_SHORT { \
    ...
    "COMMAND_SHORT", \
    5, \
    {  { "command", NULL, MACE_TYPE_UINT16_T, 0, 0, offsetof(mace_command_short_t, command) }, \
         { "target_system", NULL, MACE_TYPE_UINT8_T, 0, 2, offsetof(mace_command_short_t, target_system) }, \
         { "target_component", NULL, MACE_TYPE_UINT8_T, 0, 3, offsetof(mace_command_short_t, target_component) }, \
         { "confirmation", NULL, MACE_TYPE_UINT8_T, 0, 4, offsetof(mace_command_short_t, confirmation) }, \
         { "param", NULL, MACE_TYPE_UINT8_T, 0, 5, offsetof(mace_command_short_t, param) }, \
         } \
}
#else
#define MACE_MESSAGE_INFO_COMMAND_SHORT { \
...
static inline uint16_t mace_msg_command_short_pack(uint8_t system_id, uint8_t component_id, mace_message_t* msg,
                               uint8_t target_system, uint8_t target_component, uint16_t command, uint8_t confirmation, uint8_t param)
{
    ...
    _mace_put_uint8_t(buf, 4, confirmation);
    _mace_put_uint8_t(buf, 5, param);
...
{
    return mace_msg_command_short_pack(system_id, component_id, msg, command_short->target_system, command_short->target_component, command_short->command, command_short->confirmation, command_short->param);
}
...
{
    return mace_msg_command_short_pack_chan(system_id, component_id, chan, msg, command_short->target_system, command_short->target_component, command_short->command, command_short->confirmation, command_short->param);
}
...
static inline void mace_msg_command_short_send(mace_channel_t chan, uint8_t target_system, uint8_t target_component, uint16_t command, uint8_t confirmation, uint8_t param)
{
#if MACE_NEED_BYTE_SWAP || !MACE_ALIGNED_FIELDS
    char buf[MACE_MSG_ID_COMMAND_SHORT_LEN];
    _mace_put_uint16_t(buf, 0, command);
...
{
#if MACE_NEED_BYTE_SWAP || !MACE_ALIGNED_FIELDS
    mace_msg_command_short_send(chan, command_short->target_system, command_short->target_component, command_short->command, command_short->confirmation, command_short->param);
#else
 ...
 */
static inline void mace_msg_command_short_send_buf(mace_message_t *msgbuf, mace_channel_t chan,  uint8_t target_system, uint8_t target_component, uint16_t command, uint8_t confirmation, uint8_t param)
{
#if MACE_NEED_BYTE_SWAP || !MACE_ALIGNED_FIELDS
 ...
 */
static inline uint8_t mace_msg_command_short_get_param(const mace_message_t* msg)
{
