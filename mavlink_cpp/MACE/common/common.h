...
#define MACE_MESSAGE_CRCS {{0, 213, 6, 0, 0, 0}, {1, 204, 10, 0, 0, 0}, {2, 34, 1, 0, 0, 0}, {3, 227, 10, 0, 0, 0}, {4, 137, 12, 0, 0, 0}, {5, 237, 14, 3, 12, 13}, {6, 217, 28, 1, 0, 0}, {7, 104, 3, 0, 0, 0}, {8, 119, 32, 0, 0, 0}, {9, 214, 20, 3, 2, 3}, {10, 159, 2, 3, 0, 1}, {11, 220, 25, 0, 0, 0}, {12, 168, 23, 3, 4, 5}, {13, 24, 30, 0, 0, 0}, {14, 23, 101, 0, 0, 0}, {15, 115, 14, 0, 0, 0}, {16, 61, 12, 0, 0, 0}, {17, 239, 12, 0, 0, 0}, {18, 251, 24, 0, 0, 0}, {19, 246, 32, 0, 0, 0}, {20, 121, 16, 0, 0, 0}, {21, 62, 16, 0, 0, 0}, {22, 57, 28, 0, 0, 0}, {23, 187, 22, 0, 0, 0}, {24, 245, 10, 0, 0, 0}, {25, 128, 28, 0, 0, 0}, {26, 41, 13, 1, 12, 0}, {27, 39, 12, 0, 0, 0}, {28, 20, 20, 0, 0, 0}, {29, 158, 35, 3, 30, 31}, {30, 152, 33, 3, 30, 31}, {31, 226, 6, 3, 2, 3}, {32, 143, 3, 0, 0, 0}, {33, 129, 21, 1, 0, 0}, {34, 1, 1, 0, 0, 0}, {200, 185, 9, 0, 0, 0}, {201, 34, 16, 0, 0, 0}, {202, 203, 6, 0, 0, 0}, {203, 85, 14, 0, 0, 0}, {204, 47, 32, 0, 0, 0}, {244, 95, 6, 0, 0, 0}, {245, 130, 2, 0, 0, 0}, {246, 184, 38, 0, 0, 0}, {247, 81, 19, 0, 0, 0}, {253, 83, 51, 0, 0, 0}, {259, 122, 86, 0, 0, 0}, {260, 8, 28, 0, 0, 0}, {262, 69, 31, 0, 0, 0}, {263, 133, 255, 0, 0, 0}, {264, 49, 28, 0, 0, 0}}
#endif
...
#ifndef HAVE_ENUM_MAV_PROTOCOL
#define HAVE_ENUM_MAV_PROTOCOL
typedef enum MAV_PROTOCOL
{
   MAV_PROTOCOL_MACE=0, /* MACE protocol | */
   MAV_PROTCOL_MAVLINK=1, /* MAVLINK protocol. | */
   MAV_PROTOCOL_DJI=2, /* DJI protocol | */
   MAV_PROTOCOL_UNKNOWN=3, /* Generic autopilot, full support for everything | */
   MAV_PROTOCOL_ENUM_END=4, /*  | */
} MAV_PROTOCOL;
#endif
...
typedef enum MAV_AUTOPILOT
{
   ...
   MAV_AUTOPILOT_DJI=19, /* DJI Autopilot | */
