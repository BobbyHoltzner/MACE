// MESSAGE MACE_MISSION_REQUEST_PARTIAL_LIST support class
...
/**
 * @brief MACE_MISSION_REQUEST_PARTIAL_LIST message
 *
 ...
 */
struct MACE_MISSION_REQUEST_PARTIAL_LIST : mavlink::Message {
    ...
    static constexpr auto NAME = "MACE_MISSION_REQUEST_PARTIAL_LIST";
