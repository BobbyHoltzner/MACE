...
#define MAVLINK_MSG_ID_MACE_MISSION_REQUEST_LIST 306
...
#define MAVLINK_MSG_ID_306_LEN 3
#define MAVLINK_MSG_ID_306_MIN_LEN 3

#define MAVLINK_MSG_ID_MACE_MISSION_REQUEST_LIST_CRC 193
#define MAVLINK_MSG_ID_306_CRC 193
...
#define MAVLINK_MESSAGE_INFO_MACE_MISSION_REQUEST_LIST { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_mace_mission_request_list_t, target_system) }, \
         { "target_component", NULL, MAVLINK_TYPE_UINT8_T, 0, 1, offsetof(mavlink_mace_mission_request_list_t, target_component) }, \
         { "mission_type", NULL, MAVLINK_TYPE_UINT8_T, 0, 2, offsetof(mavlink_mace_mission_request_list_t, mission_type) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_MACE_MISSION_REQUEST_LIST { \
...
{
    return mavlink_msg_mace_mission_request_list_pack(system_id, component_id, msg, mace_mission_request_list->target_system, mace_mission_request_list->target_component, mace_mission_request_list->mission_type);
}
...
{
    return mavlink_msg_mace_mission_request_list_pack_chan(system_id, component_id, chan, msg, mace_mission_request_list->target_system, mace_mission_request_list->target_component, mace_mission_request_list->mission_type);
}
...
static inline void mavlink_msg_mace_mission_request_list_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, uint8_t mission_type)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_MACE_MISSION_REQUEST_LIST_LEN];
    _mav_put_uint8_t(buf, 0, target_system);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_mace_mission_request_list_send(chan, mace_mission_request_list->target_system, mace_mission_request_list->target_component, mace_mission_request_list->mission_type);
#else
 ...
 */
static inline void mavlink_msg_mace_mission_request_list_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t target_component, uint8_t mission_type)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field target_component from mace_mission_request_list message
 *
 * @return Component ID
 */
static inline uint8_t mavlink_msg_mace_mission_request_list_get_target_component(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_mace_mission_request_list_decode(const mavlink_message_t* msg, mavlink_mace_mission_request_list_t* mace_mission_request_list)
{
    ...
    mace_mission_request_list->target_component = mavlink_msg_mace_mission_request_list_get_target_component(msg);
