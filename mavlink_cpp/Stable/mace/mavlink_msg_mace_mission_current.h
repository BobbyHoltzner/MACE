...
/**
 * @brief Pack a mace_mission_current message
                               ...
                               uint16_t seq)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_MACE_MISSION_CURRENT;
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_MACE_MISSION_CURRENT_MIN_LEN, MAVLINK_MSG_ID_MACE_MISSION_CURRENT_LEN, MAVLINK_MSG_ID_MACE_MISSION_CURRENT_CRC);
}

/**
 * @brief Pack a mace_mission_current message on a channel
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
                                   ...
                                   uint16_t seq)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_MACE_MISSION_CURRENT;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_MACE_MISSION_CURRENT_MIN_LEN, MAVLINK_MSG_ID_MACE_MISSION_CURRENT_LEN, MAVLINK_MSG_ID_MACE_MISSION_CURRENT_CRC);
}

/**
 * @brief Encode a mace_mission_current struct
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param msg The MAVLink message to compress the data into
 * @param mace_mission_current C-struct to read the message contents from
 */
...
/**
 * @brief Encode a mace_mission_current struct on a channel
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param chan The MAVLink channel this message will be sent over
...
#if MAVLINK_MSG_ID_MACE_MISSION_CURRENT_LEN <= MAVLINK_MAX_PAYLOAD_LEN
/*
 ...
 * @return Sequence
 */
static inline uint16_t mavlink_msg_mace_mission_current_get_seq(const mavlink_message_t* msg)
{
    return _MAV_RETURN_uint16_t(msg,  0);
}

/**
 * @brief Decode a mace_mission_current message into a struct
 *
 * @param msg The message to decode
 * @param mace_mission_current C-struct to decode the message contents into
 */
static inline void mavlink_msg_mace_mission_current_decode(const mavlink_message_t* msg, mavlink_mace_mission_current_t* mace_mission_current)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    ...
    memcpy(mace_mission_current, _MAV_PAYLOAD(msg), len);
#endif
}
