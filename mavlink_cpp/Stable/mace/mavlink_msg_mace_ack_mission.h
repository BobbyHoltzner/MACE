...
#define MAVLINK_MSG_ID_MACE_ACK_MISSION_CRC 52
#define MAVLINK_MSG_ID_183_CRC 52
...
#define MAVLINK_MESSAGE_INFO_MACE_ACK_MISSION { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_mace_ack_mission_t, target_system) }, \
         { "target_component", NULL, MAVLINK_TYPE_UINT8_T, 0, 1, offsetof(mavlink_mace_ack_mission_t, target_component) }, \
...
static inline uint16_t mavlink_msg_mace_ack_mission_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t target_system, uint8_t target_component, uint8_t mission_creator, uint8_t mission_id, uint8_t mission_type, uint8_t mission_state)
{
...
{
    return mavlink_msg_mace_ack_mission_pack(system_id, component_id, msg, mace_ack_mission->target_system, mace_ack_mission->target_component, mace_ack_mission->mission_creator, mace_ack_mission->mission_id, mace_ack_mission->mission_type, mace_ack_mission->mission_state);
}
...
{
    return mavlink_msg_mace_ack_mission_pack_chan(system_id, component_id, chan, msg, mace_ack_mission->target_system, mace_ack_mission->target_component, mace_ack_mission->mission_creator, mace_ack_mission->mission_id, mace_ack_mission->mission_type, mace_ack_mission->mission_state);
}
...
static inline void mavlink_msg_mace_ack_mission_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, uint8_t mission_creator, uint8_t mission_id, uint8_t mission_type, uint8_t mission_state)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_MACE_ACK_MISSION_LEN];
    _mav_put_uint8_t(buf, 0, target_system);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_mace_ack_mission_send(chan, mace_ack_mission->target_system, mace_ack_mission->target_component, mace_ack_mission->mission_creator, mace_ack_mission->mission_id, mace_ack_mission->mission_type, mace_ack_mission->mission_state);
#else
 ...
 */
static inline void mavlink_msg_mace_ack_mission_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t target_component, uint8_t mission_creator, uint8_t mission_id, uint8_t mission_type, uint8_t mission_state)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field target_component from mace_ack_mission message
 *
 * @return Component ID
 */
static inline uint8_t mavlink_msg_mace_ack_mission_get_target_component(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_mace_ack_mission_decode(const mavlink_message_t* msg, mavlink_mace_ack_mission_t* mace_ack_mission)
{
    ...
    mace_ack_mission->target_component = mavlink_msg_mace_ack_mission_get_target_component(msg);
