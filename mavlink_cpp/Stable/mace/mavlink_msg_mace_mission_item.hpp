// MESSAGE MACE_MISSION_ITEM support class
...
/**
 * @brief MACE_MISSION_ITEM message
 *
 ...
 */
struct MACE_MISSION_ITEM : mavlink::Message {
    static constexpr msgid_t MSG_ID = 302;
    static constexpr size_t LENGTH = 38;
    static constexpr size_t MIN_LENGTH = 38;
    static constexpr uint8_t CRC_EXTRA = 18;
    static constexpr auto NAME = "MACE_MISSION_ITEM";
