...
#define MAVLINK_MSG_ID_MACE_MISSION_COUNT_MIN_LEN 7
#define MAVLINK_MSG_ID_185_LEN 7
#define MAVLINK_MSG_ID_185_MIN_LEN 7

#define MAVLINK_MSG_ID_MACE_MISSION_COUNT_CRC 55
#define MAVLINK_MSG_ID_185_CRC 55
...
static inline uint16_t mavlink_msg_mace_mission_count_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t target_system, uint8_t mission_system, uint8_t mission_creator, uint8_t mission_id, uint8_t mission_type, uint16_t count)
{
...
{
    return mavlink_msg_mace_mission_count_pack(system_id, component_id, msg, mace_mission_count->target_system, mace_mission_count->mission_system, mace_mission_count->mission_creator, mace_mission_count->mission_id, mace_mission_count->mission_type, mace_mission_count->count);
}
...
{
    return mavlink_msg_mace_mission_count_pack_chan(system_id, component_id, chan, msg, mace_mission_count->target_system, mace_mission_count->mission_system, mace_mission_count->mission_creator, mace_mission_count->mission_id, mace_mission_count->mission_type, mace_mission_count->count);
}
...
static inline void mavlink_msg_mace_mission_count_send(mavlink_channel_t chan, uint8_t target_system, uint8_t mission_system, uint8_t mission_creator, uint8_t mission_id, uint8_t mission_type, uint16_t count)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_MACE_MISSION_COUNT_LEN];
    _mav_put_uint16_t(buf, 0, count);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_mace_mission_count_send(chan, mace_mission_count->target_system, mace_mission_count->mission_system, mace_mission_count->mission_creator, mace_mission_count->mission_id, mace_mission_count->mission_type, mace_mission_count->count);
#else
 ...
 */
static inline void mavlink_msg_mace_mission_count_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t mission_system, uint8_t mission_creator, uint8_t mission_id, uint8_t mission_type, uint16_t count)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
