...
#define MAVLINK_MSG_ID_MACE_MISSION_COUNT 307
...
#define MAVLINK_MSG_ID_MACE_MISSION_COUNT_LEN 5
#define MAVLINK_MSG_ID_MACE_MISSION_COUNT_MIN_LEN 5
#define MAVLINK_MSG_ID_307_LEN 5
#define MAVLINK_MSG_ID_307_MIN_LEN 5

#define MAVLINK_MSG_ID_MACE_MISSION_COUNT_CRC 122
#define MAVLINK_MSG_ID_307_CRC 122
...
{
    return mavlink_msg_mace_mission_count_pack(system_id, component_id, msg, mace_mission_count->target_system, mace_mission_count->target_component, mace_mission_count->count, mace_mission_count->mission_type);
}
...
{
    return mavlink_msg_mace_mission_count_pack_chan(system_id, component_id, chan, msg, mace_mission_count->target_system, mace_mission_count->target_component, mace_mission_count->count, mace_mission_count->mission_type);
}
...
static inline void mavlink_msg_mace_mission_count_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, uint16_t count, uint8_t mission_type)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_MACE_MISSION_COUNT_LEN];
    _mav_put_uint16_t(buf, 0, count);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_mace_mission_count_send(chan, mace_mission_count->target_system, mace_mission_count->target_component, mace_mission_count->count, mace_mission_count->mission_type);
#else
 ...
 */
static inline void mavlink_msg_mace_mission_count_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t target_component, uint16_t count, uint8_t mission_type)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
