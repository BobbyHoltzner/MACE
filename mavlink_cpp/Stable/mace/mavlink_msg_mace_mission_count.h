...
typedef struct __mavlink_mace_mission_count_t {
 ...
 uint8_t mission_state; /*< The mission state, see MACE_MISSION_STATE*/
 ...
 * @param mission_state The mission state, see MACE_MISSION_STATE
 ...
 *
 * @return The mission state, see MACE_MISSION_STATE
 */
