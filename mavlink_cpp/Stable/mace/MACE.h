...
/** @brief The type of acknowledgement the vehicle can have with a mission item. */
#ifndef HAVE_ENUM_MACE_MISSION_ACK
#define HAVE_ENUM_MACE_MISSION_ACK
typedef enum MACE_MISSION_ACK
{
   MACE_MISSION_ACK_DENIED=0, /* The mission was not accepted by the aircraft. | */
   MACE_MISSION_ACK_ACCEPTED=1, /* The mission was accepted by the aircraft | */
   MACE_MISSION_ACK_ACCEPTED_CHANGED_TYPE=2, /* The mission was accepted by the aircraft however the type was unsupported and therefore changed. | */
   MACE_MISSION_ACK_ACCEPTED_CHANGED_KEY=3, /* The mission was accepted by the aircraft and associated module, however, the key required changing. | */
   MACE_MISSION_ACK_ENUM_END=4, /*  | */
} MACE_MISSION_ACK;
#endif
...
#include "./mavlink_msg_mace_vehicle_sync.h"
