...
#ifndef HAVE_ENUM_MACE_MISSION_PROFILE
#define HAVE_ENUM_MACE_MISSION_PROFILE
typedef enum MACE_MISSION_PROFILE
{
   MAV_MISSION_TYPE_AUTO=0, /* Items are mission commands for main mission. | */
   MAV_MISSION_TYPE_GUIDED=1, /* Items are mission commands for guided mission. | */
   MAV_MISSION_TYPE_FENCE=2, /* Specifies GeoFence area(s). Items are MAV_CMD_FENCE_ GeoFence items. | */
   MAV_MISSION_TYPE_RALLY=3, /* Specifies the rally points for the vehicle. Rally points are alternative RTL points. Items are MAV_CMD_RALLY_POINT rally point items. | */
   MAV_MISSION_TYPE_ALL=255, /* Only used in MISSION_CLEAR_ALL to clear all mission types. | */
   MACE_MISSION_PROFILE_ENUM_END=256, /*  | */
} MACE_MISSION_PROFILE;
#endif
