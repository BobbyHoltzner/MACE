...
{
   MACE_MISSION_CURRENT=0, /* Items are mission commands for main auto mission. | */
   MACE_MISSION_ONBOARD=1, /* Items are mission commands for guided mission. | */
   MACE_MISSION_PROPOSED=2, /* Items are regions of interest that the vehicle should visit in a guided mission. | */
   MACE_MISSION_STATE_ENUM_END=3, /*  | */
} MACE_MISSION_STATE;
#endif
