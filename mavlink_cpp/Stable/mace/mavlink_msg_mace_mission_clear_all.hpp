// MESSAGE MACE_MISSION_CLEAR_ALL support class
...
/**
 * @brief MACE_MISSION_CLEAR_ALL message
 *
 * Delete all mission items at once.
 */
struct MACE_MISSION_CLEAR_ALL : mavlink::Message {
    static constexpr msgid_t MSG_ID = 308;
    static constexpr size_t LENGTH = 3;
    static constexpr size_t MIN_LENGTH = 3;
    static constexpr uint8_t CRC_EXTRA = 93;
    static constexpr auto NAME = "MACE_MISSION_CLEAR_ALL";
