// MESSAGE MACE_MISSION_REQUEST support class
...
/**
 * @brief MACE_MISSION_REQUEST message
 *
 * Request the information of the mission item with the sequence number seq. The response of the system to this message should be a MISSION_ITEM message. http://qgroundcontrol.org/mavlink/waypoint_protocol
 */
struct MACE_MISSION_REQUEST : mavlink::Message {
    static constexpr msgid_t MSG_ID = 303;
    static constexpr size_t LENGTH = 5;
    static constexpr size_t MIN_LENGTH = 5;
    static constexpr uint8_t CRC_EXTRA = 255;
    static constexpr auto NAME = "MACE_MISSION_REQUEST";
