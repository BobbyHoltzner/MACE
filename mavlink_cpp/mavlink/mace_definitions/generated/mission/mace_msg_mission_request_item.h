...
#define MACE_MSG_ID_MISSION_REQUEST_ITEM 105
...
#define MACE_MSG_ID_MISSION_REQUEST_ITEM_LEN 7
#define MACE_MSG_ID_MISSION_REQUEST_ITEM_MIN_LEN 7
#define MACE_MSG_ID_105_LEN 7
#define MACE_MSG_ID_105_MIN_LEN 7

#define MACE_MSG_ID_MISSION_REQUEST_ITEM_CRC 19
#define MACE_MSG_ID_105_CRC 19
...
{
    return mace_msg_mission_request_item_pack(system_id, component_id, msg, mission_request_item->target_system, mission_request_item->mission_system, mission_request_item->mission_creator, mission_request_item->mission_id, mission_request_item->mission_type, mission_request_item->seq);
}
...
{
    return mace_msg_mission_request_item_pack_chan(system_id, component_id, chan, msg, mission_request_item->target_system, mission_request_item->mission_system, mission_request_item->mission_creator, mission_request_item->mission_id, mission_request_item->mission_type, mission_request_item->seq);
}
...
static inline void mace_msg_mission_request_item_send(mace_channel_t chan, uint8_t target_system, uint8_t mission_system, uint8_t mission_creator, uint8_t mission_id, uint8_t mission_type, uint16_t seq)
{
#if MACE_NEED_BYTE_SWAP || !MACE_ALIGNED_FIELDS
    char buf[MACE_MSG_ID_MISSION_REQUEST_ITEM_LEN];
    _mace_put_uint16_t(buf, 0, seq);
...
{
#if MACE_NEED_BYTE_SWAP || !MACE_ALIGNED_FIELDS
    mace_msg_mission_request_item_send(chan, mission_request_item->target_system, mission_request_item->mission_system, mission_request_item->mission_creator, mission_request_item->mission_id, mission_request_item->mission_type, mission_request_item->seq);
#else
 ...
 */
static inline void mace_msg_mission_request_item_send_buf(mace_message_t *msgbuf, mace_channel_t chan,  uint8_t target_system, uint8_t mission_system, uint8_t mission_creator, uint8_t mission_id, uint8_t mission_type, uint16_t seq)
{
#if MACE_NEED_BYTE_SWAP || !MACE_ALIGNED_FIELDS
