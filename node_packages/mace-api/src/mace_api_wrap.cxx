...
#define SWIGTYPE_p_MaceAPI swig_types[0]
...
#define SWIGTYPE_p_signed___int64 swig_types[9]
#define SWIGTYPE_p_signed_char swig_types[10]
#define SWIGTYPE_p_std__string swig_types[11]
#define SWIGTYPE_p_unsigned___int64 swig_types[12]
...
#define SWIGV8_INIT MaceAPI_initialize


SWIGV8_ClientData _exports_MaceAPI_clientData;


static SwigV8ReturnValue _wrap_new_MaceAPI(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  v8::Handle<v8::Object> self = args.Holder();
  MaceAPI *result;
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_MaceAPI.");
  result = (MaceAPI *)new MaceAPI();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_MaceAPI, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static SwigV8ReturnValue _wrap_MaceAPI_addOne(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  v8::Handle<v8::Value> jsresult;
  MaceAPI *arg1 = (MaceAPI *) 0 ;
  double arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  double val2 ;
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_MaceAPI_addOne.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_MaceAPI, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MaceAPI_addOne" "', argument " "1"" of type '" "MaceAPI *""'"); 
  }
  arg1 = (MaceAPI *)(argp1);
  ecode2 = SWIG_AsVal_double(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "MaceAPI_addOne" "', argument " "2"" of type '" "double""'");
  } 
  arg2 = (double)(val2);
  result = (double)(arg1)->addOne(arg2);
...
static SwigV8ReturnValue _wrap_MaceAPI_getTestDouble(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_MaceAPI_getTestDouble.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_MaceAPI, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MaceAPI_getTestDouble" "', argument " "1"" of type '" "MaceAPI *""'"); 
  }
  arg1 = (MaceAPI *)(argp1);
  result = (double)(arg1)->getTestDouble();
  jsresult = SWIG_From_double((double)(result));
...
static SwigV8ReturnValue _wrap_MaceAPI_newVehicle(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_MaceAPI_newVehicle.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_MaceAPI, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MaceAPI_newVehicle" "', argument " "1"" of type '" "MaceAPI *""'"); 
  }
  arg1 = (MaceAPI *)(argp1);
  res2 = SWIG_ConvertPtr(args[0], &argp2, SWIGTYPE_p_std__string,  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "MaceAPI_newVehicle" "', argument " "2"" of type '" "std::string const &""'"); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "MaceAPI_newVehicle" "', argument " "2"" of type '" "std::string const &""'"); 
  }
  arg2 = (std::string *)(argp2);
  (arg1)->newVehicle((std::string const &)*arg2);
...
#if (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < 0x031710)
static void _wrap_delete_MaceAPI(v8::Persistent<v8::Value> object, void *parameter) {
  SWIGV8_Proxy *proxy = static_cast<SWIGV8_Proxy *>(parameter);
#elif (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < 0x031900)
  static void _wrap_delete_MaceAPI(v8::Isolate *isolate, v8::Persistent<v8::Value> object, void *parameter) {
    SWIGV8_Proxy *proxy = static_cast<SWIGV8_Proxy *>(parameter);
#elif (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < SWIGV8_SETWEAK_VERSION)
    static void _wrap_delete_MaceAPI(v8::Isolate *isolate, v8::Persistent< v8::Object> *object, SWIGV8_Proxy *proxy) {
#else
      static void _wrap_delete_MaceAPI(const v8::WeakCallbackData<v8::Object, SWIGV8_Proxy> &data) {
        v8::Local<v8::Object> object = data.GetValue();
        SWIGV8_Proxy *proxy = data.GetParameter();
#endif
        
        if(proxy->swigCMemOwn && proxy->swigCObject) {
          MaceAPI * arg1 = (MaceAPI *)proxy->swigCObject;
          delete arg1;
        }
        delete proxy;
...
static swig_type_info _swigt__p_MaceAPI = {"_p_MaceAPI", "p_MaceAPI|MaceAPI *", 0, 0, (void*)0, 0};
...
static swig_cast_info _swigc__p_MaceAPI[] = {  {&_swigt__p_MaceAPI, 0, 0, 0},{0, 0, 0, 0}};
...
#endif
{
  ...
  /* Name: _exports_MaceAPI, Type: p_MaceAPI, Dtor: _wrap_delete_MaceAPI */
v8::Handle<v8::FunctionTemplate> _exports_MaceAPI_class = SWIGV8_CreateClassTemplate("_exports_MaceAPI");
SWIGV8_SET_CLASS_TEMPL(_exports_MaceAPI_clientData.class_templ, _exports_MaceAPI_class);
_exports_MaceAPI_clientData.dtor = _wrap_delete_MaceAPI;
if (SWIGTYPE_p_MaceAPI->clientdata == 0) {
  SWIGTYPE_p_MaceAPI->clientdata = &_exports_MaceAPI_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_MaceAPI_class, "addOne", _wrap_MaceAPI_addOne);
SWIGV8_AddMemberFunction(_exports_MaceAPI_class, "getTestDouble", _wrap_MaceAPI_getTestDouble);
SWIGV8_AddMemberFunction(_exports_MaceAPI_class, "newVehicle", _wrap_MaceAPI_newVehicle);
  ...
  /* class instances */
  /* Class: MaceAPI (_exports_MaceAPI) */
v8::Handle<v8::FunctionTemplate> _exports_MaceAPI_class_0 = SWIGV8_CreateClassTemplate("MaceAPI");
_exports_MaceAPI_class_0->SetCallHandler(_wrap_new_MaceAPI);
_exports_MaceAPI_class_0->Inherit(_exports_MaceAPI_class);
_exports_MaceAPI_class_0->SetHiddenPrototype(true);
v8::Handle<v8::Object> _exports_MaceAPI_obj = _exports_MaceAPI_class_0->GetFunction();
  ...
  /* register classes */
  exports_obj->Set(SWIGV8_SYMBOL_NEW("MaceAPI"), _exports_MaceAPI_obj);
...
NODE_MODULE(MaceAPI, MaceAPI_initialize)
#endif
