...
export default class AppContainer extends React.Component<Props, State> {
    ...
    componentDidMount() {
        ...
        this.appHelper.maceCommsHelper.makeTCPRequest(
            0,
        ...
        setInterval(() => {
            if (!this.appHelper.pauseMACEComms) {
                this.setState({
                    connectedVehicles: this.appHelper.maceCommsHelper.vehicleDB
                        .vehicles
                })
            }
        }, 1500)
    ...
    handleDrawerAction = (action: string) => {
        if (action === "MACEConfig") {
            ...
            this.appHelper.maceCommsHelper.makeTCPRequest(
                parseInt(this.state.selectedVehicleID),
                "TEST_FUNCTION1",
                ""
            )
    ...
    contextGoHere = () => {
        ...
        this.handleAircraftCommand(
            this.state.selectedVehicleID,
            "SET_GO_HERE",
            JSON.stringify(goHere)
        )
    }
    ...
    handleSelectedAircraftUpdate = (id: string) => {
        ...
        Object.keys(this.state.connectedVehicles).map((key: string) => {
            if (key === id) {
                ...
                if (
                    stateCopy[id].isSelected === true &&
                    (stateCopy[id].position.lat !== 0 &&
                        stateCopy[id].position.lat !== 0)
                ) {
    ...
    handleSubmitBoundary = () => {
        this.appHelper.maceCommsHelper.makeTCPRequest(
            0,
            "SET_ENVIRONMENT_VERTICES",
            JSON.stringify({ boundary: this.polygonHelper.drawPolygonPts })
        )
            ...
            <MuiThemeProvider muiTheme={lightMuiTheme}>
                <div style={styles.parentStyle}>
                    ...
                    <ConnectedVehiclesContainer
                        ...
                        handleChangeSelectedVehicle={
                            this.handleSelectedAircraftUpdate
                        }
                    ...
                    {this.state.showEditVehicleHomeDialog && (
                        <VehicleHomeDialog
                            ...
                            allowVehicleSelect={
                                this.appHelper.allowVehicleSelect
                            }
                            onSelectedAircraftChange={
                                this.handleSelectedAircraftUpdate
                            }
                    ...
                    {this.state.showEditGlobalHomeDialog && (
                        <GlobalOriginDialog
                            ...
                            globalOrigin={
                                this.appHelper.maceCommsHelper.vehicleDB
                                    .globalOrigin
                            }
                    ...
                    {this.state.showMessagesMenu && (
                        <MessagesDialog
                            ...
                            handleClose={this.handleCloseDialogs}
                            handleSave={
                                this.appHelper.handleSaveMessagingPreferences
                            }
                            preferences={
                                this.appHelper.maceCommsHelper.vehicleDB
                                    .messagePreferences
                    ...
                    {this.state.showConfigDialog && (
                        <ConfigDialog
                            ...
                            handleSave={(
                                ...
                                this.appHelper.handleSaveMACEConfig(
                                    configSettings,
                                    reload
                                )
                            }
                            ...
                            handleParseJSON={(
                                ...
                                this.appHelper.parseJSONConfig(
                                    filename,
                                    restartServer
                                )
                            }
                    ...
                    {this.state.showTakeoffDialog && (
                        <TakeoffDialog
                            ...
                            handleSaveTakeoff={(alt: string) =>
                                this.handleSaveTakeoff(alt)
                            }
                            contextAnchor={this.state.contextAnchor}
                            useContext={this.state.useContext}
                            showNotification={this.showNotification}
                    ...
                    {this.polygonHelper.showDraw && (
                        <DrawButtonsContainer
                            onDeleteLastPolygonPt={
                                this.polygonHelper.handleDeleteLastPolygonPt
                            }
                            ...
                            handleChangeGridSpacing={
                                this.polygonHelper.handleChangeGridSpacing
                            }
                            openEnvironmentSettings={
                                this.handleOpenEnvironmentSettings
                            }
                            environmentSettings={
                                this.polygonHelper.environmentSettings
                            }
                        />
                    )}
                    ...
                    {this.state.showEnvironmentSettings && (
                        <EnvironmentSettings
                            ...
                            handleClose={this.handleCloseDialogs}
                            handleSave={
                                this.polygonHelper.saveEnvironmentSettings
                            }
                            environmentSettings={
                                this.polygonHelper.environmentSettings
                            }
                    ...
                    <MACEMap
                        handleSelectedAircraftUpdate={
                            this.handleSelectedAircraftUpdate
                        }
                        setContextAnchor={(anchor: L.LeafletMouseEvent) =>
                            this.setState({ contextAnchor: anchor })
                        }
                        connectedVehicles={this.state.connectedVehicles}
                        selectedVehicleID={this.state.selectedVehicleID}
                        mapCenter={
                            this.appHelper.MACEconfig.config.GUIInit.mapCenter
                        }
                        maxZoom={
                            this.appHelper.MACEconfig.config.GUIInit.maxZoom
                        }
                        mapZoom={
                            this.appHelper.MACEconfig.config.GUIInit.mapZoom
                        }
                        globalOrigin={
                            this.appHelper.maceCommsHelper.vehicleDB
                                .globalOrigin
