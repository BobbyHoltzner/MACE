            ...
            <MuiThemeProvider muiTheme={lightMuiTheme}>
                ...
                >
                    <div style={styles.logo}>
                        <img
                            className="image"
                            src={"images/HeronLogo_Small.png"}
                        />
                    </div>
                    ...
                    <MenuItem
                        onTouchTap={() =>
                            this.props.onDrawerAction("TestButton1")
                        }
                    >
                        <FlatButton
                    ...
                    <MenuItem
                        onTouchTap={() =>
                            this.props.onDrawerAction("TestButton2")
                        }
                    >
                        <FlatButton
                            labelStyle={styles.drawerItemLabelStyle}
                    ...
                    <MenuItem
                        onTouchTap={() =>
                            this.props.onDrawerAction("EditEnvironment")
                        }
                    >
                        <FlatButton
                            labelStyle={styles.drawerItemLabelStyle}
                    ...
                    */}
                    ...
                    <MenuItem
                        onTouchTap={() =>
                            this.setState({
                                openSettingsSubmenu: !this.state
                                    .openSettingsSubmenu
                            })
                        }
                    >
                        ...
                        {this.state.openSettingsSubmenu && (
                            <div>
                                <MenuItem
                                    onTouchTap={() =>
                                        this.props.onDrawerAction("MACEConfig")
                                    }
                                >
                                    <FlatButton
                                        labelStyle={styles.drawerItemLabelStyle}
                                ...
                                <MenuItem
                                    onTouchTap={() =>
                                        this.props.onDrawerAction("Messages")
                                    }
                                >
                                    <FlatButton
                                        labelStyle={styles.drawerItemLabelStyle}
                                ...
                                <MenuItem
                                    onTouchTap={() =>
                                        this.props.onDrawerAction("Takeoff")
                                    }
                                >
                                    <FlatButton
                                        labelStyle={styles.drawerItemLabelStyle}
