                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <input
                                            ...
                                            id="file"
                                            className="inputfile"
                                            onChange={this.chooseFileChange}
                                        />
                                        <label htmlFor="file">
                                ...
                                >
                                    ...
                                    >
                                        <TextField
                                            ...
                                            onChange={this.handleTextChange}
                                            value={
                                                this.state.configSettings.config
                                                    .MACEComms.ipAddress
                                            }
                                        />
                                    </Col>
