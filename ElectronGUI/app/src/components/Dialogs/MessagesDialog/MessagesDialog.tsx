                        ...
                        <Col xs={12} md={6}>
                            <Col xs={12} md={12}>
                                <Checkbox
                                    ...
                                    onCheck={(event: any, checked: boolean) =>
                                        this.handleCheck(checked, "emergency")
                                    }
                            ...
                            <Col xs={12} md={12}>
                                <Checkbox
                                    ...
                                    style={styles.checkboxStyle}
                                    onCheck={(event: any, checked: boolean) =>
                                        this.handleCheck(checked, "critical")
                                    }
                            ...
                            <Col xs={12} md={12}>
                                <Checkbox
                                    ...
                                    style={styles.checkboxStyle}
                                    onCheck={(event: any, checked: boolean) =>
                                        this.handleCheck(checked, "alert")
                                    }
                            ...
                            <Col xs={12} md={12}>
                                <Checkbox
                                    ...
                                    style={styles.checkboxStyle}
                                    onCheck={(event: any, checked: boolean) =>
                                        this.handleCheck(checked, "error")
                                    }
                        ...
                        <Col xs={12} md={6}>
                            <Col xs={12} md={12}>
                                <Checkbox
                                    ...
                                    style={styles.checkboxStyle}
                                    onCheck={(event: any, checked: boolean) =>
                                        this.handleCheck(checked, "warning")
                                    }
                            ...
                            <Col xs={12} md={12}>
                                <Checkbox
                                    ...
                                    style={styles.checkboxStyle}
                                    onCheck={(event: any, checked: boolean) =>
                                        this.handleCheck(checked, "notice")
                                    }
                            ...
                            <Col xs={12} md={12}>
                                <Checkbox
                                    ...
                                    style={styles.checkboxStyle}
                                    onCheck={(event: any, checked: boolean) =>
                                        this.handleCheck(checked, "debug")
                                    }
