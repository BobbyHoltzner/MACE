...
export class VehicleHomeDialog extends React.Component<Props, State> {
    constructor(props: Props) {
        ...
        let homeLat = this.props.vehicles[this.props.selectedVehicleID]
            ? this.props.vehicles[this.props.selectedVehicleID].homePosition
                  .latLon.lat
            : 0
        let homeLon = this.props.vehicles[this.props.selectedVehicleID]
            ? this.props.vehicles[this.props.selectedVehicleID].homePosition
                  .latLon.lng
            : 0
    ...
    handleSave = () => {
        ...
        if (this.state.selectedVehicleID !== "0") {
            ...
            this.props.showNotification(
                title,
                "Select a vehicle to set home coordinates for.",
                level,
                "tc",
                "Got it"
            )
