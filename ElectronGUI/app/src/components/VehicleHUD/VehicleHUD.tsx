...
export class VehicleHUD extends React.Component<Props, State> {
    ...
    componentWillReceiveProps(nextProps: Props) {
        ...
        if (nextProps.aircraft.messages.length > 0) {
            ...
            let diff = Math.abs(
                now.getTime() -
                    nextProps.aircraft.messages[0].timestamp.getTime()
            )
            if (diff > 10000) {
        ...
        if (
            nextProps.aircraft.vehicleMode !== this.props.aircraft.vehicleMode
        ) {
            this.setState({ vehicleModeText: nextProps.aircraft.vehicleMode })
        }

        let now = new Date()
        const lastHeardSeconds =
            (now.getTime() - this.props.aircraft.general.lastHeard.getTime()) /
    ...
    handleLoiter = () => {
        this.props.handleAircraftCommand(
    ...
    render() {
        ...
        const boxShadow = this.props.aircraft.isSelected
            ? this.props.highlightColor +
              " 0px 1px 20px, rgba(0, 0, 0, .5) 0px 1px 4px"
        ...
        const hudAvatar: JSX.Element = (
            <Avatar
                backgroundColor={
                    this.props.aircraft.isArmed
                        ? Colors.Success
                        : Colors.Primary
                }
                src={aircraftImgSrcFromType(
                    this.props.aircraft.general.aircraftType
                )}
                style={styles.avatar}
            />
        )
                ...
                <div className="col-xs-6" style={styles.col_thin}>
                    ...
                    <div className="col-xs-12" style={styles.col_thin}>
                        ...
                        <div className="col-xs-6" style={styles.col_iconLabel}>
                            <span style={styles.iconLabelText}>
                                {this.props.aircraft.gps.gpsFix}
                            </span>
                        </div>
                    </div>
                    <div className="col-xs-12" style={styles.col_thin}>
                        ...
                        <div className="col-xs-6" style={styles.col_iconLabel}>
                            <span style={styles.iconLabelText}>
                                {this.props.aircraft.gps.visibleSats}
                            </span>
                        </div>
                    </div>
                </div>
        ...
        return (
            <MuiThemeProvider muiTheme={lightMuiTheme}>
                <Card
                    expanded={true}
                    onExpandChange={() =>
                        this.props.handleChangeSelectedVehicle(
                            this.props.vehicleID
                        )
                    }
                    style={hudStyle}
                            ...
                            <div className="box">
                                ...
                                */}
                                <CardText style={styles.cardText}>
                                    {"Alt: " +
                                        this.props.aircraft.position.alt.toFixed(
                                            2
                                        )}
                                </CardText>
                                <CardText style={styles.cardText}>
                                    {"Airspeed: " +
                                        this.props.aircraft.airspeed.toFixed(2)}
                                </CardText>
                                <div
                                    className="col-xs-5"
                                ...
                                >
                                    <IconMenu
                                        ...
                                        onChange={(e: any, value: string) =>
                                            this.handleBatteryChange(value)
                                        }
                        ...
                        <div className="col-xs-6">
                            <div className="box">
                                <CardText style={styles.rpyText}>
                                    {"Roll: " +
                                        this.props.aircraft.attitude.roll.toFixed(
                                            2
                                        )}
                                </CardText>
                                <CardText style={styles.rpyText}>
                                    {"Pitch: " +
                                        this.props.aircraft.attitude.pitch.toFixed(
                                            2
                                        )}
                                </CardText>
                                <CardText style={styles.rpyText}>
                                    {"Yaw: " +
                                        this.props.aircraft.attitude.yaw.toFixed(
                                            2
                                        )}
                                </CardText>
                            </div>
                            ...
                            this.state.showHUDMessage && (
                                <div className="col-xs-12">
                                    ...
                                    <div className="box">
                                        ...
                                        >
                                            {"[" +
                                                this.props.aircraft.messages[0]
                                                    .severity +
                                                "] : " +
                                                this.props.aircraft.messages[0]
                                                    .text}
