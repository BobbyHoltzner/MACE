...
State_FlightRTL::State_FlightRTL(ControllerFactory *controllerFactory):
...
bool State_FlightRTL::handleCommand(const AbstractCommandItem* command)
{
...
void State_FlightRTL::OnEnter(const AbstractCommandItem *command)
{
    this->OnEnter();
}
