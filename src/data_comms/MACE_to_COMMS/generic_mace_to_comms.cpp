...
mavlink_message_t Generic_COMMSTOMAVLINK::FlightMode_COMMSTOMAVLINK(std::shared_ptr<DataGenericItemTopic::DataGenericItemTopic_FlightMode> flightModeItem, const int &systemID, const uint8_t &chan, const uint8_t &compID)
{
...
mavlink_message_t Generic_COMMSTOMAVLINK::Fuel_COMMSTOMAVLINK(DataGenericItem::DataGenericItem_Fuel fuelItem, const int &systemID, const uint8_t &chan, const uint8_t &compID)
{
    mavlink_message_t msg;
...
mavlink_message_t Generic_COMMSTOMAVLINK::GPS_COMMSTOMAVLINK(DataGenericItem::DataGenericItem_GPS GPSItem, const int &systemID, const uint8_t &chan, const uint8_t &compID)
{
    mavlink_message_t msg;
    mavlink_heartbeat_t heartbeat;
    //mavlink_msg_sys_status_encode_chan(systemID,compID,chan,&msg,&sysStatus);
...
mavlink_message_t Generic_COMMSTOMAVLINK::Text_COMMSTOMAVLINK(DataGenericItem::DataGenericItem_Text textItem, const int &systemID, const uint8_t &chan, const uint8_t &compID)
{
    mavlink_message_t msg;
