...
//!
template<typename MESSAGE_TYPE, typename COMPONENT_KEY, typename CONTROLLER_TYPE, typename FINAL_TYPE, typename MSG_TYPE, const int MESSAGE_REQUEST_ID>
...
protected:
    ...
    //!
    virtual bool Construct_FinalObject(const MSG_TYPE &msg, const COMPONENT_KEY &sender, std::shared_ptr<FINAL_TYPE> &data)= 0;
