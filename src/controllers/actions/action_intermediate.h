...
template<typename CONTROLLER_TYPE, typename QUEUE_TYPE, typename MSG_TYPE, const int MESSAGE_REQUEST_ID, typename ACK_TYPE, const int ...MESSAGE_ACK_ID>
class ActionIntermediate :
        public ActionIntermediateReceive<CONTROLLER_TYPE, QUEUE_TYPE, MSG_TYPE, MESSAGE_REQUEST_ID, ACK_TYPE>,
...
public:
    ...
    ActionIntermediate(CONTROLLER_TYPE *controller,
        ...
        ActionIntermediateReceive<CONTROLLER_TYPE, QUEUE_TYPE, MSG_TYPE, MESSAGE_REQUEST_ID, ACK_TYPE>(controller,
                                  [this](const ACK_TYPE &A, const MaceCore::ModuleCharacteristic &B, const QUEUE_TYPE &C, const MaceCore::ModuleCharacteristic &D){ActionIntermediateRespond<CONTROLLER_TYPE, ACK_TYPE, MESSAGE_ACK_ID...>::NextTransmission(A,B,C,D);},
                                  decode),
